...
class SedeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'ALM_SerieNotaCreditoBoleta'  => ['nullable', 'string', 'max:4'],
            'ALM_SerieNotaCreditoFactura' => ['nullable', 'string', 'max:4'],
            ...
            'ALM_CorrelativoInicialBoleta'             => ['nullable', 'integer', 'min:0'],
            'ALM_CorrelativoInicialFactura'             => ['nullable', 'integer', 'min:0'],
            'ALM_CorrelativoInicialNotaCreditoBoleta'   => ['nullable', 'integer', 'min:0'],
            'ALM_CorrelativoInicialNotaCreditoFactura'  => ['nullable', 'integer', 'min:0'],
            'ALM_CorrelativoInicialGuiaRemision'        => ['nullable', 'integer', 'min:0'],
        ...
        try {
            $almacen = DB::transaction(function () use ($request, $validated) {
                ...
                return Almacen::create([
                    ...
                    'ALM_SerieNotaCreditoBoleta'  => isset($validated['ALM_SerieNotaCreditoBoleta']) ? strtoupper($validated['ALM_SerieNotaCreditoBoleta']) : null,
                    'ALM_SerieNotaCreditoFactura' => isset($validated['ALM_SerieNotaCreditoFactura']) ? strtoupper($validated['ALM_SerieNotaCreditoFactura']) : null,
                    ...
                    'ALM_CorrelativoInicialBoleta'            => $validated['ALM_CorrelativoInicialBoleta'] ?? null,
                    'ALM_CorrelativoInicialFactura'           => $validated['ALM_CorrelativoInicialFactura'] ?? null,
                    'ALM_CorrelativoInicialNotaCreditoBoleta'  => $validated['ALM_CorrelativoInicialNotaCreditoBoleta'] ?? null,
                    'ALM_CorrelativoInicialNotaCreditoFactura' => $validated['ALM_CorrelativoInicialNotaCreditoFactura'] ?? null,
                    'ALM_CorrelativoInicialGuiaRemision'       => $validated['ALM_CorrelativoInicialGuiaRemision'] ?? null,
