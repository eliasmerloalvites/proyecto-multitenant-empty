...
use App\Http\Controllers\Tenant\Generico\CotizacionController as GenericoCotizacionController;
...
Route::middleware([
    ...
    Route::middleware(['tenant.module:mantenimientos'])->group(function () {
        ...
        Route::middleware(['tenant.module:ventas'])->group(function () {
            ...
            // nombre en tenant.ventas.cotizacion.* para quien se registre
            // despues.
            Route::get('/tenant/ventas/cotizacion-generico', [GenericoCotizacionController::class, 'index'])->name('tenant.ventas.cotizacion.index.generico');
            Route::get('/tenant/ventas/cotizacion-generico/crear', [GenericoCotizacionController::class, 'create'])->name('tenant.ventas.cotizacion.create.generico');
            Route::post('/tenant/ventas/cotizacion-generico', [GenericoCotizacionController::class, 'store'])->name('tenant.ventas.cotizacion.store.generico');
            Route::get('/tenant/ventas/cotizacion-generico/{cotizacion}', [GenericoCotizacionController::class, 'show'])->name('tenant.ventas.cotizacion.show.generico');
            Route::get('/tenant/ventas/cotizacion-generico/{cotizacion}/editar', [GenericoCotizacionController::class, 'edit'])->name('tenant.ventas.cotizacion.edit.generico');
            Route::put('/tenant/ventas/cotizacion-generico/{cotizacion}', [GenericoCotizacionController::class, 'update'])->name('tenant.ventas.cotizacion.update.generico');
            Route::get('/tenant/ventas/cotizacion-generico/{cotizacion}/pdf', [GenericoCotizacionController::class, 'pdf'])->name('tenant.ventas.cotizacion.pdf.generico');
            Route::post('/tenant/ventas/cotizacion-generico/{cotizacion}/anular', [GenericoCotizacionController::class, 'anular'])->name('tenant.ventas.cotizacion.anular.generico');
            ...
            Route::post('/tenant/ventas/cotizacion-generico/{cotizacion}/marcar-convertida', [GenericoCotizacionController::class, 'marcarConvertida'])->name('tenant.ventas.cotizacion.marcarConvertida.generico');
        ...
        Route::middleware(['tenant.module:productos'])->group(function () {
            ...
            Route::put('/tenant/inventario/producto/{producto}/activar', [ProductoController::class, 'activar'])->name('tenant.inventario.producto.activar');

            Route::post('/tenant/inventario/producto/{producto}/galeria', [ProductoController::class, 'subirImagenGaleria'])->name('tenant.inventario.producto.galeria.store');
            Route::delete('/tenant/inventario/producto/galeria/{producto}/{item}', [ProductoController::class, 'eliminarImagenGaleria'])->name('tenant.inventario.producto.galeria.destroy');
