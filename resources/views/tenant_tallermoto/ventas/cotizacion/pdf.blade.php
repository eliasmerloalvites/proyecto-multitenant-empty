...
<style>
    * { box-sizing: border-box; }
    ...
    .encabezado { display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 3px solid #6C3BFF; padding-bottom: 16px; margin-bottom: 20px; }
    ...
    .cot-titulo { font-size: 22px; font-weight: 900; color: #6C3BFF; letter-spacing: .02em; }
    ...
    .info-box { flex: 1; background: #F9FAFB; border-radius: 12px; padding: 12px 16px; }
    ...
    table.items th {
        background: #6C3BFF; color: #fff; text-align: left; font-size: 10.5px; font-weight: 700;
    ...
    .totales-fila.total { border-top: 2px solid #111827; margin-top: 4px; padding-top: 10px; font-size: 17px; font-weight: 900; color: #6C3BFF; }
