...
@section('contenido')
    ...
    <div class="col-lg-5  col-md-12 col-sm-12 col-xs-12 ">
        ...
        <form action="{{ tenant_url('tenant.ventas.venta.store') }}" method="POST" id="venta_form">
            @csrf
                    ...
                    <div class="card mt-2" id="idfrmCliente" style="display: none;">
                        <div class="card-body">
                            ...
                            <form method="POST" id="cliente_form"
                                action="{{ tenant_url('tenant.ventas.cliente.store') }}">
                                @csrf
        ...
        <script>
            ...
            function aceptar() {
                ...
                $.ajax({
                    ...
                    url: "{{ tenant_url('tenant.ventas.venta.store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function(data) {
                        console.log('Success:', data);
