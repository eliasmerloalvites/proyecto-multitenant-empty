...
<body class="hold-transition sidebar-mini   ">
    <div class="wrapper">
        ...
        {{-- Navbar --}}
        @include('tenant_tallermoto.partials.navbar')

        {{-- Sidebar --}}
        @include('tenant_tallermoto.partials.sidebar')

        {{-- Content --}}
        @include('tenant_tallermoto.partials.container')

        {{-- Control Sidebar --}}
        @include('tenant_tallermoto.partials.controlSidebar')
