    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.editTurno', function() {
                ...
                $.get(
                    '{{ tenant_url('tenant.configuracion.turno.edit', ['turno' => ':turno', 'tenant' => tenant('id')]) }}'
            ...
            $('#updateBtn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ tenant_url('tenant.configuracion.turno.update', ['turno' => ':turno', 'tenant' => tenant('id')]) }}'
                        .replace(':turno', turnoId),
                    type: "PUT",
                    data: $('#turno_form').serialize(),
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteTurno', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        ...
                        url: '{{ tenant_url('tenant.configuracion.turno.destroy', ['turno' => ':turno', 'tenant' => tenant('id')]) }}'
                            .replace(':turno', turnoId),
                        type: "DELETE",
            ...
            $('body').on('click', '.activarTurno', function() {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        ...
                        url: '{{ tenant_url('tenant.configuracion.turno.activar', ['turno' => ':turno', 'tenant' => tenant('id')]) }}'
                            .replace(':turno', turnoId),
                        type: "PUT",
