                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                type="password"
                                class="form-control"
                                value="{{ $empresa->certificado_password ?? '' }}"
                ...
                <div class="card config-card">
                    ...
                    <div class="card-body">
                        <div class="logo-upload-box">
                            <img
                                id="preview_logo"
                                src="{{ asset_root('images/imagen_default.png') }}"
                                class="logo-preview"
                            >
                        </div>
                        <div class="custom-file">
