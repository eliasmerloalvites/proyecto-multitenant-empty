                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12 row">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <input type="datetime-local" class="form-control" id="MPI_FechaTermino"
                                            ...
                                            value="{{ $datos->MPI_FechaTermino ? \Carbon\Carbon::parse($datos->MPI_FechaTermino)->format('Y-m-d\TH:i') : '' }}">
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-lg-8 col-md-8 col-sm-12 col-12">
                                        ...
                                        <textarea class="form-control" rows="2" name="MPI_Recomendacion"
                                            onkeyup="this.value=this.value.toUpperCase();">{{ $datos->MPI_Recomendacion }}</textarea>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12">
                                        <label>Prioridad</label>
                                        <select class="form-control" name="MPI_RecomendacionPrioridad">
                                            <option value="">Sin prioridad</option>
                                            @foreach (['ALTA' => 'Alta', 'MEDIA' => 'Media', 'BAJA' => 'Baja'] as $valor => $etiqueta)
                                                <option value="{{ $valor }}" {{ $datos->MPI_RecomendacionPrioridad === $valor ? 'selected' : '' }}>{{ $etiqueta }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-8 col-md-8 col-sm-12 col-12">
                                        <label>Otros</label>
                                        <input type="text" class="form-control" name="MPI_VerifOtros"
                                            onKeyUp="this.value=this.value.toUpperCase();"
                                            value="{{ $datos->MPI_VerifOtros }}" maxlength="150">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12">
                                        <label>&nbsp;</label>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input"
                                                {{ $datos->MPI_VerifConforme ? 'checked' : '' }} name="MPI_VerifConforme"
                                                id="switchMPIVerifConforme">
                                            <label class="custom-control-label" for="switchMPIVerifConforme">Conforme para entrega</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        function cargarTabla() {
            ...
            for (var i = ListDet.length - 1; i >= 0; i--) {
                ...
                if (esBahia) {
                    ...
                    col2 = '<td style="text-align: left;"><input id="MPID_Descripcion' + i +
                        '" type="hidden" name="MPID_Descripcion[]" value="' + ListDet[i][0] +
                        '">' + ListDet[i][0] + '</td>'
                    col3 = '<td style="text-align: left;"><input id="MPI_Precio' + i +
