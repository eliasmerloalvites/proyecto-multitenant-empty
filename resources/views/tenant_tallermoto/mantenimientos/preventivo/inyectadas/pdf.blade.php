        ...
        <div class="header no-break">
            ...
            <table class="header-table">
                <tr>
                    ...
                    <td width="47%">
                        <div class="title">
                            FORMATO DE MANTENIMIENTO PREVENTIVO INYECTADA
                        </div>
                        <div class="subtitle">
                    ...
                    <td width="25%">
                        <div class="header-info">
                            ...
                            <strong>FECHA:</strong> {{ date('d/m/Y', strtotime($mttoPreventivo->MPI_FechaCreacion)) }}
                            <br>
                            <strong>HORA:</strong> {{ date('H:i:s', strtotime($mttoPreventivo->MPI_FechaCreacion)) }}
                        </div>
                    </td>
                </tr>
            </table>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det1 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det1 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det2 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det2 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det3 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det3 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det4 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det4 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det5 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det5 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det6 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det6 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det7 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det7 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det8 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det8 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                            <table style="width: 100%;">
                                <tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det9 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det9 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det10 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det10 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det11 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det11 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det12 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det12 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det13 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det13 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        <td class="number">{{ $itemNum++ }}.0</td>
                        <td class="description">LIMPIEZA DE CONECTORES ELÃ‰CTRICOS</td>
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det14 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det14 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        <td class="number">{{ $itemNum++ }}.0</td>
                        <td class="description">REVISIÃ“N DEL SISTEMA DE ENFRIAMIENTO</td>
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det17 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det17 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                            <table style="width: 100%;">
                                <tr>
...
<tr>
                        <td class="number">{{ $itemNum++ }}.0</td>
                        <td class="description">LUBRICACIÃ“N DEL SISTEMA DE ARRASTRE</td>
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det18 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det18 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
...
<tr>
                        <td class="number">{{ $itemNum++ }}.0</td>
                        <td class="description">MEDICIÃ“N DE VOLTAJE DE CARGA DE BATERÃA</td>
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det19 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det19 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
...
<tr>
                        <td class="number">{{ $itemNum++ }}.0</td>
                        <td class="description">VERIFICACIÃ“N DEL SISTEMA DE LUCES</td>
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPI_Det20 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPI_Det20 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
