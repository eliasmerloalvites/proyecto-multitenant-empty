        ...
        <div class="form-scroll-container">
            <form id="MantenimientoPreventivoInyectadasForm" name="MantenimientoPreventivoInyectadasForm"
                ...
                <div class="d-flex justify-content-between align-items-center ">
                    <div>
                        <h4>CREAR MANTENIMIENTO PREVENTIVO INYECTADAS</h4>
                    </div>
                </div>
                <div class="row">
                    <!-- DATOS -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <input type="number" class="form-control form-control-sm" id="MPC_Det9"
                                            name="MPC_Det9" placeholder="## PSI" value="" required="">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 "style="text-align: left">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <input type="number" class="form-control form-control-sm" id="MPC_Det10"
                                            name="MPC_Det10" placeholder="## PSI" value="" required="">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 "style="text-align: left">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MPC_Det11Vida"
                                                name="MPC_Det11Vida" placeholder="%. VIDA UTIL: #% " value=""
                                                maxlength="20" required="">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MPC_Det11Carga"
                                                name="MPC_Det11Carga" placeholder="V. Carga: ## " value=""
                                                maxlength="20" required="">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MPC_Det11Arranque"
    ...
    <script>
        ...
        function AgregarMPC() {
            $.ajax({
                ...
                url: "{{ route('tenant.mantenimientos.preventivocarburada.store') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    ...
                    document.location.href =
                        "{{ route('tenant.mantenimientos.preventivocarburada.index') }}/" + data.id +
                        '/edit';
                },
                error: function(data) {
                    console.log('Error:', data);
