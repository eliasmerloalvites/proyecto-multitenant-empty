...
<head>
    ...
    <title>Formato Mantenimiento Preventivo Carburadas</title>
        ...
        <div class="header no-break">
            ...
            <table class="header-table">
                <tr>
                    ...
                    <td width="47%">
                        <div class="title">
                            FORMATO DE MANTENIMIENTO PREVENTIVO CARBURADA
                        </div>
                        <div class="subtitle">
            ...
            <div class="service-content">
                ...
                <table class="service-table">
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPC_Det1 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPC_Det1 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPC_Det2 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPC_Det2 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPC_Det3 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPC_Det3 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPC_Det4 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPC_Det4 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPC_Det5 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPC_Det5 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPC_Det6 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPC_Det6 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MPC_Det11 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MPC_Det11 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
