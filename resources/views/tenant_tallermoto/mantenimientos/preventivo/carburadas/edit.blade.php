                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12 row">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <input type="datetime-local" class="form-control" id="MPC_FechaInicio"
                                            name="MPC_FechaInicio"
                                            value="{{ $datos->MPC_FechaInicio ? \Carbon\Carbon::parse($datos->MPC_FechaInicio)->format('Y-m-d\TH:i') : '' }}">
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
...
@section('script')
    <script>
        ...
        function cargarData() {
            ...
            $('#MPC_FechaInicio').val(`<?php echo $datos->MPC_FechaInicio ? \Carbon\Carbon::parse($datos->MPC_FechaInicio)->format('Y-m-d\TH:i') : ''; ?>`);
        ...
        function cargarTabla() {
            ...
            for (var i = ListDet.length - 1; i >= 0; i--) {
                ...
                if (esBahia) {
                    ...
                    col2 = '<td style="text-align: left;"><input id="MPCD_Descripcion' + i +
                        '" type="hidden" name="MPCD_Descripcion[]" value="' + ListDet[i][0] +
                        '">' + ListDet[i][0] + '</td>'
                    col3 = '<td style="text-align: left;"><input id="MPC_Precio' + i +
