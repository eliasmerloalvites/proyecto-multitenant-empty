        ...
        <div class="header no-break">
            ...
            <table class="header-table">
                <tr>
                    ...
                    <td width="47%">
                        <div class="title">
                            FORMATO DE MANTENIMIENTO GENERAL INYECTADA
                        </div>
                        <div class="subtitle">
                    ...
                    <td width="25%">
                        <div class="header-info">
                            ...
                            <strong>HORA:</strong> {{ date('H:i:s', strtotime($mttoPreventivo->MGI_FechaCreacion)) }}
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <div class="service-content">
                ...
                <table class="service-table">
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det1 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det1 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det2 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det2 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det3 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det3 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det4 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det4 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det5 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det5 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det6 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det6 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det7 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det7 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det8 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det8 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det9 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det9 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det10 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det10 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                            <table style="width: 100%;">
                                <tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det11 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det11 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                            <table style="width: 100%;">
                                <tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det12 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det12 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det13 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det13 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det14 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det14 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det15 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det15 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det16 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det16 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det17 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det17 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det20 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det20 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                            <table style="width: 100%;">
                                <tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det21 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det21 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det22 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det22 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                            <table style="width: 100%;">
                                <tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det23 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det23 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det25 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det25 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det26 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det26 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="status">
                            <span
                                class="status-{{ $mttoPreventivo->MGI_Det27 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGI_Det27 == 'SI' ? 'OK' : 'NO' }}</span>
                        </td>
                        <td class="reference">
                        </td>
                    </tr>
