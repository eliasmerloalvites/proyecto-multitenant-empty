...
@section('titulo', 'Creacion Mantenimiento General Inyectada')
@section('contenido')
    <style>
        .card-title-custom {
            font-size: 15px;
        ...
        <div class="form-scroll-container">
            <form id="MantenimientoGeneralInyectadasForm" name="MantenimientoGeneralInyectadasForm" onsubmit="return false;">
                <div class="d-flex justify-content-between align-items-center ">
                    <div>
                        <h4>CREAR MANTENIMIENTO GENERAL INYECTADAS</h4>
                    </div>
                </div>
                <div class="row">
                    <!-- DATOS -->
                        ...
                        <div class="card card-outline card-info shadow-sm section-card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det1"
                                                id="customSwitch1">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12" style="text-align: center">
                                        <input type="text" class="form-control form-control-sm"
                                            onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det1Informacion"
                                            name="MGI_Det1Informacion" placeholder="Ingrese informacion" value=""
                                            maxlength="50">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det2"
                                                id="customSwitch2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det3"
                                                id="customSwitch3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det4"
                                                id="customSwitch4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det5"
                                                id="customSwitch5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det6"
                                                id="customSwitch6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det7"
                                                id="customSwitch7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det8"
                                                id="customSwitch8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det9"
                                                id="customSwitch9">
                                    ...
                                    <div
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det9Admision"
                                                name="MGI_Det9Admision" placeholder="Admision: #.## mm" value=""
                                                maxlength="10" required="">
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det9Escape"
                                                name="MGI_Det9Escape" placeholder="Escape #.## mm" value=""
                                                maxlength="10" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det10"
                                                id="customSwitch10">
                                    ...
                                    <div
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det10Medida"
                                                name="MGI_Det10Medida" placeholder="Medida: #.## mm" value=""
                                                maxlength="10" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det11"
                                                id="customSwitch11">
                                    ...
                                    <div
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det11Medida"
                                                name="MGI_Det11Medida" placeholder="Medida: #.## mm" value=""
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det12"
                                                id="customSwitch12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det13"
                                                id="customSwitch13">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det14"
                                                id="customSwitch14">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det15"
                                                id="customSwitch15">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det16"
                                                id="customSwitch16">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det17"
                                                id="customSwitch17">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <input type="number" class="form-control form-control-sm" id="MGI_Det18"
                                            name="MGI_Det18" placeholder="## PSI" value="" required="">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 "style="text-align: left">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <input type="number" class="form-control form-control-sm" id="MGI_Det19"
                                            name="MGI_Det19" placeholder="## PSI" value="" required="">
                                    </div>
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 "style="text-align: left">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det20"
                                                id="customSwitch20">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 "style="text-align: left">
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det20Humedad"
                                                name="MGI_Det20Humedad" placeholder="% HUMEDAD " value=""
                                                maxlength="10" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det21"
                                                id="customSwitch21">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det22"
                                                id="customSwitch22">
                                    ...
                                    <div
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det22Ventilador"
                                                name="MGI_Det22Ventilador" placeholder="Ventilador: ## " value=""
                                                maxlength="10" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det23"
                                                id="customSwitch23">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det24"
                                                id="customSwitch24">
                                    ...
                                    <div
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det24Vida"
                                                name="MGI_Det24Vida" placeholder="%. VIDA UTIL: #% " value=""
                                                maxlength="20" required="">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det24Carga"
                                                name="MGI_Det24Carga" placeholder="V. Carga: ## " value=""
                                                maxlength="20" required="">
                                        </div>
                                        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 "style="text-align: left">
                                            <input type="text" class="form-control form-control-sm"
                                                onKeyUp="this.value=this.value.toUpperCase();" id="MGI_Det24Arranque"
                                                name="MGI_Det24Arranque" placeholder="V. ARRANQUE: ## DVC "
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det25"
                                                id="customSwitch25">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det26"
                                                id="customSwitch26">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-1 col-md-1 col-sm-3 col-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="MGI_Det27"
                                                id="customSwitch27">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" align="left">
                                    ...
                                    <textarea onKeyUp="handleText(this);" name="MGI_CorrecionObservacion" id="MGI_CorrecionObservacion"
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12 row">
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <input type="text" class="form-control"
                                            onKeyUp="this.value=this.value.toUpperCase();" id="MGI_ProximoCambioAceite"
                                            name="MGI_ProximoCambioAceite" placeholder="#### KM" value=""
                                            maxlength="50" required="">
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-12">
                                        <label for="name" class=" control-label">PROXIMO SERVICIO</label>
                                        <input type="text" class="form-control"
                                            onKeyUp="this.value=this.value.toUpperCase();" id="MGI_ProximoServicio"
                                            name="MGI_ProximoServicio" placeholder="#### KM" value=""
                                            maxlength="50" required="">
                                    </div>
                                </div>
    ...
    <script>
        ...
        function cargarTabla() {
            ...
            for (var i = ListDetVenta.length - 1; i >= 0; i--) {
                ...
                var col2 = '<td style="text-align: left;"><input id="MGID_Descripcion' + i +
                    '" type="hidden" name="MGID_Descripcion[]" value="' + ListDetVenta[i][0] +
                    '">' + ListDetVenta[i][0] + '</td>'
                var col3 = '<td style="text-align: left;"><input id="MGI_Precio' + i +
                    '" type="hidden" name="MGI_Precio[]" value="' + ListDetVenta[i][1] +
                    '">' + ListDetVenta[i][1] + '</td>'
                var col4 =
        ...
        function AgregarMGI() {
            $.ajax({
                ...
                url: "{{ route('tenant.mantenimientos.generalinyectada.store') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    ...
                    document.location.href =
                        "{{ route('tenant.mantenimientos.generalinyectada.index') }}/" + data.id +
                        '/edit';
                },
                error: function(data) {
                    console.log('Error:', data);
