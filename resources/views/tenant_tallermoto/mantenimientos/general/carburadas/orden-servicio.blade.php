...
<head>
    ...
    <title>Orden de Servicio - Mantenimiento General Carburada</title>
...
<body>
    ...
    <div class="container">
                ...
                <tr>
                    ...
                    <td width="25%">
                        <div class="header-info">
                            <strong>N° ORDEN:</strong> MGC-{{ str_pad($mttoPreventivo->MGC_Id, 6, '0', STR_PAD_LEFT) }} <br>
                            <strong>FECHA:</strong> {{ date('d/m/Y', strtotime($mttoPreventivo->MGC_FechaCreacion)) }} <br>
                            <strong>HORA:</strong> {{ date('H:i:s', strtotime($mttoPreventivo->MGC_FechaCreacion)) }} <br>
                                ...
                                <table class="client-table">
                                    <tr>
                                        ...
                                        <td width="50%">
                                            ...
                                            <div class="client-value">
                                                <span class="badge-estado" style="background:{{ $coloresEstado[$mttoPreventivo->MGC_Estado] ?? '#64748b' }}">
                                                    {{ $mttoPreventivo->MGC_Estado }}
                                                </span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <div class="client-value {{ empty($mttoPreventivo->MGC_FechaInicio) ? 'blank' : '' }}">
                                                {{ $mttoPreventivo->MGC_FechaInicio ? date('d/m/Y H:i', strtotime($mttoPreventivo->MGC_FechaInicio)) : 'Sin registrar' }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="client-label">FECHA DE ENTREGA</div>
                                            <div class="client-value {{ empty($mttoPreventivo->MGC_FechaTermino) ? 'blank' : '' }}">
                                                {{ $mttoPreventivo->MGC_FechaTermino ? date('d/m/Y H:i', strtotime($mttoPreventivo->MGC_FechaTermino)) : 'Sin registrar' }}
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                ...
                <table class="service-table">
                    ...
                    @if($mttoPreventivo->MGC_Det1 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det1 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det1 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference">
                    ...
                    @if($mttoPreventivo->MGC_Det2 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det2 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det2 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                    ...
                    @if($mttoPreventivo->MGC_Det3 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det3 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det3 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det4 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det4 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det4 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det5 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det5 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det5 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det6 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det6 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det6 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det7 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det7 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det7 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det8 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det8 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det8 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference">
                    ...
                    @if($mttoPreventivo->MGC_Det9 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det9 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det9 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference">
                                <table style="width: 100%;">
                                    <tr>
                    ...
                    @if($mttoPreventivo->MGC_Det10 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det10 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det10 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det11 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det11 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det11 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det12 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det12 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det12 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det13 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det13 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det13 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det14 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det14 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det14 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det15 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det15 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det15 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det18 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det18 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det18 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference">
                                <table style="width: 100%;">
                                    <tr>
                    ...
                    @if($mttoPreventivo->MGC_Det19 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det19 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det19 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference">
                                <table style="width: 100%;">
                                    <tr>
                    ...
                    @if($mttoPreventivo->MGC_Det20 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det20 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det20 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference"></td>
                        </tr>
                    @endif
                    ...
                    @if($mttoPreventivo->MGC_Det21 == 'SI')
                        <tr>
                            ...
                            <td class="status">
                                <span class="status-{{ $mttoPreventivo->MGC_Det21 == 'SI' ? 'ok' : 'no' }}">{{ $mttoPreventivo->MGC_Det21 == 'SI' ? 'OK' : 'NO' }}</span>
                            </td>
                            <td class="reference">
                                <table style="width: 100%;">
                                    <tr>
        ...
        @php
            ...
            $verifItems = [
                'MGC_VerifArranque' => 'Arranque correcto',
                'MGC_VerifLuces' => 'Luces',
                'MGC_VerifDireccionales' => 'Direccionales',
                'MGC_VerifNivelAceite' => 'Nivel de aceite',
                'MGC_VerifPruebaRuta' => 'Prueba de ruta',
                'MGC_VerifLavado' => 'Lavado',
            ];
        @endphp
        ...
        <div class="section no-break">
            ...
            <div class="section-body">
                @if ($mttoPreventivo->MGC_Recomendacion)
                    @if ($mttoPreventivo->MGC_RecomendacionPrioridad)
                        <span class="badge-estado" style="background:{{ $coloresPrioridad[$mttoPreventivo->MGC_RecomendacionPrioridad] }}">
                            PRIORIDAD {{ $mttoPreventivo->MGC_RecomendacionPrioridad }}
                        </span>
                    @endif
                    <div style="margin-top:6px; font-size:11px; color:#334155;">{{ $mttoPreventivo->MGC_Recomendacion }}</div>
                @else
        ...
        <div class="section no-break">
            ...
            <div class="section-body">
                ...
                @if ($mttoPreventivo->MGC_VerifOtros)
                    <div style="margin-top:6px; font-size:10.5px;"><strong>Otros:</strong> {{ $mttoPreventivo->MGC_VerifOtros }}</div>
                @endif
                <div style="margin-top:8px; font-size:10.5px;">
                    <strong>Conforme para entrega:</strong>
                    <span class="rec-tag {{ $mttoPreventivo->MGC_VerifConforme ? 'rec-tag-ok' : 'rec-tag-blank' }}">
                        {{ $mttoPreventivo->MGC_VerifConforme ? 'SÍ' : 'PENDIENTE' }}
                    </span>
                    &nbsp;&nbsp; <strong>Técnico:</strong> {{ $mttoPreventivo->personal }}
                    &nbsp;&nbsp; <strong>Fecha:</strong>
                    {{ $mttoPreventivo->MGC_FechaTermino ? date('d/m/Y', strtotime($mttoPreventivo->MGC_FechaTermino)) : 'Sin registrar' }}
                </div>
            </div>
        </div>
