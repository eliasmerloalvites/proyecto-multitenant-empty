...
<div class="container ">
    <form action="{{tenant_url('tenant.seguridad.usuario.update',[$usuario->id])}}" method="post">
        @method('put')
        @csrf
       ...
       <center> <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Guardar</button>
        <a href="{{tenant_url('tenant.seguridad.usuario.cancelar')}}" class="btn btn-danger" ><i class="fas fa-ban"></i> Regresar</a></center>
    </form>
