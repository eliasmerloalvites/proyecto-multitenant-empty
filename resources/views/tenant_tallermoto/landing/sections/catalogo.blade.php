                ...
                <div @class([
                    ...
                    <div class="space-y-2">
                        ...
                        <h2
                            ...
                            Catálogo Oficial <span class="text-brand-500">{{ $empresa->nombre_comercial }}</span>
                        </h2>

                        <p class="{{ $colorview == 'dark' ? 'text-gray-400' : 'text-gray-600' }} text-xs max-w-md">
                            Repuestos originales, lubricantes y accesorios seleccionados para mantener tu motocicleta
                            con el
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div @class([
                            ...
                            <div class="relative">
                                ...
                                <div @class([
                                    ...
                                    <img src="{{ asset_root('/storage/' . $tiponegocio . '/' . $tenantid . '/archivos/producto/' . $data->PRO_Imagen) }}" alt="Kit de Arrastre"
                            ...
                            <div class="p-4 space-y-3 flex-grow flex flex-col justify-between">
                                <div class="space-y-1">
                                    <div class="flex items-center justify-between">
                                        <span
                                            class="text-[10px] text-brand-500 font-bold uppercase tracking-wider">{{ $data->CAT_Nombre }}</span>
                                        <span class="text-[10px] text-gray-500 font-medium">Cod: {{ $data->PRO_Id }}</span>
                                    </div>
                                    <h3
                                ...
                                <div @class([
                                    ...
                                    <span class="text-gray-500 font-mono">{{ $data->PRO_Marca }}</span>
                                </div>
                                ...
                                <div @class([
                                    ...
                                    <div>
                                        <span
                                            class="block text-[9px] uppercase tracking-wider text-gray-400 font-bold">Precio
                                            Referencial</span>
                                        <span
                                            class="{{ $colorview == 'dark' ? 'text-white' : 'text-gray-900' }} text-base font-black font-mono">
                                            S/ {{ number_format($data->PRO_PrecioVenta, 0) }}.<span class="text-xs">{{ sprintf('%02d', ($data->PRO_PrecioVenta - floor($data->PRO_PrecioVenta)) * 100) }}</span>
                                        </span>
                                    </div>
                    ...
                    {{-- <div @class([
                        ...
                        <div class="p-4 space-y-3 flex-grow flex flex-col justify-between">
                            <div class="space-y-1">
                                <div class="flex items-center justify-between">
                                    <span class="text-[10px] text-brand-500 font-bold uppercase tracking-wider">Sistema
                                        de
                                        Frenado</span>
                                ...
                                <p
                                    class="{{ $colorview == 'dark' ? 'text-gray-400' : 'text-gray-600' }} text-[11px] line-clamp-2">
                                    Máximo coeficiente de fricción térmica. Frenado preciso en seco y mojado sin
                                    desgaste
                                    prematuro del disco.
                                </p>
                            </div>
                    ...
                    <div @class([
                        ...
                        <div class="p-4 space-y-3 flex-grow flex flex-col justify-between">
                            <div class="space-y-1">
                                <div class="flex items-center justify-between">
                                    <span
                                        class="text-[10px] text-brand-500 font-bold uppercase tracking-wider">Lubricación
                                        Premium</span>
                                ...
                                <p
                                    class="{{ $colorview == 'dark' ? 'text-gray-400' : 'text-gray-600' }} text-[11px] line-clamp-2">
                                    Aceite 100% sintético basado en tecnología de Ésteres. Protección óptima de motor,
                                    caja
                                    y embrague húmedo.
                                </p>
                            </div>
                    ...
                    <div @class([
                        ...
                        <div class="p-4 space-y-3 flex-grow flex flex-col justify-between">
                            <div class="space-y-1">
                                <div class="flex items-center justify-between">
                                    <span
                                        class="text-[10px] text-brand-500 font-bold uppercase tracking-wider">Encendido
                                        y
                                        Rendimiento</span>
