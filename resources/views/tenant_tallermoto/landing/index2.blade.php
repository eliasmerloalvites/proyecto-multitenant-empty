        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <span class="text-2xl font-black tracking-wider text-white flex items-center">
                    <span class="text-blue-500 font-extrabold mr-0.5">K</span>KAEL
                </span>
            </div>

            <nav class="hidden md:flex items-center gap-8 text-xs font-semibold uppercase tracking-widest">
                <a href="#" class="text-blue-500 border-b-2 border-blue-500 pb-1">Inicio</a>
            ...
            <div class="flex items-center gap-5">
                <a href="#" class="text-xs font-medium text-gray-400 hover:text-white transition flex items-center gap-1.5">
                    <i data-lucide="user" class="w-4 h-4 text-blue-500"></i> Acceso Administrador
                </a>
                <a href="#" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-xs font-bold flex items-center gap-2 transition shadow-lg shadow-blue-600/20">
    ...
    <main class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-12 flex-grow flex flex-col justify-center space-y-12 relative z-10">
        ...
        <div id="buscar-placa" class="glass-panel rounded-2xl p-6 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center shadow-xl">
            <div class="lg:col-span-4 flex items-center gap-4">
                <div class="p-3 bg-blue-950/40 text-blue-400 rounded-xl border border-blue-900/30 shrink-0">
            ...
            <form action="#" method="GET" class="lg:col-span-8 grid grid-cols-1 sm:grid-cols-12 gap-4 w-full">
                <div class="sm:col-span-9 relative">
                    ...
                    <input type="text" name="placa" placeholder="Ej: ABC123, BCD456" 
                        class="w-full pl-11 pr-4 py-3.5 bg-slate-950/50 border border-white/10 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition font-mono uppercase tracking-wider text-xs">
                </div>
                <button type="submit" class="sm:col-span-3 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-xl transition flex items-center justify-center gap-2 text-xs shadow-lg shadow-blue-600/20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 pt-6 border-t border-white/5">
            <div class="flex items-start gap-3">
                <i data-lucide="calendar-days" class="w-4 h-4 text-blue-500 shrink-0 mt-0.5"></i>
                <div>
            ...
            <div class="flex items-start gap-3">
                <i data-lucide="file-text" class="w-4 h-4 text-blue-500 shrink-0 mt-0.5"></i>
                <div>
            ...
            <div class="flex items-start gap-3">
                <i data-lucide="map-pin" class="w-4 h-4 text-blue-500 shrink-0 mt-0.5"></i>
                <div>
            ...
            <div class="flex items-start gap-3">
                <i data-lucide="package" class="w-4 h-4 text-blue-500 shrink-0 mt-0.5"></i>
                <div>
