        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <span class="text-2xl font-black tracking-wider text-slate-900 flex items-center">
                    <span class="text-brand-600 font-extrabold mr-0.5">K</span>KAEL
                </span>
            </div>

            <nav class="hidden md:flex items-center gap-8 text-sm font-semibold">
                <a href="#" class="text-brand-600 border-b-2 border-brand-600 pb-1">Inicio</a>
                <a href="#" class="text-slate-600 hover:text-brand-600 transition">Servicios</a>
                <a href="#" class="text-slate-600 hover:text-brand-600 transition">Reservar</a>
                <a href="#" class="text-slate-600 hover:text-brand-600 transition">Historial</a>
                <a href="#" class="text-slate-600 hover:text-brand-600 transition">Catálogo</a>
                <a href="#" class="text-slate-600 hover:text-brand-600 transition">Nosotros</a>
                <a href="#" class="text-slate-600 hover:text-brand-600 transition">Contacto</a>
            </nav>
            ...
            <div class="flex items-center gap-5">
                ...
                <a href="#" class="bg-indigo-600 hover:bg-indigo-700 {{ $colorview == 'dark' ? 'text-gray-400' : 'text-gray-600' }} px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition shadow-md shadow-indigo-600/20">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-6 space-y-6">
                <div class="inline-flex items-center gap-2 bg-brand-50 border border-brand-100 px-3 py-1.5 rounded-full text-xs font-bold text-brand-600">
                ...
                <div class="grid grid-cols-3 gap-4 text-xs font-semibold text-slate-700 max-w-xl pt-2">
                    <div class="flex items-center gap-2">
                        <div class="p-2 bg-brand-50 text-brand-600 rounded-xl"><i data-lucide="check-circle" class="w-4 h-4"></i></div>
                        <span>Técnicos certificados</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="p-2 bg-brand-50 text-brand-600 rounded-xl"><i data-lucide="layers" class="w-4 h-4"></i></div>
                        <span>Repuestos originales</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="p-2 bg-brand-50 text-brand-600 rounded-xl"><i data-lucide="shield" class="w-4 h-4"></i></div>
                        <span>Garantía de servicio</span>
                    </div>
                </div>

                <div class="flex flex-wrap gap-4 pt-4">
                    <a href="#" class="bg-brand-600 hover:bg-brand-700 {{ $colorview == 'dark' ? 'text-gray-400' : 'text-gray-600' }} px-8 py-3.5 rounded-xl font-bold flex items-center gap-2 transition shadow-lg shadow-brand-600/20">
                        <i data-lucide="calendar" class="w-5 h-5"></i> Reservar Ahora
                    </a>
                    <a href="#buscar-placa" class="border-2 border-brand-600 text-brand-600 hover:bg-brand-50 px-8 py-3.5 rounded-xl font-bold flex items-center gap-2 transition">
            ...
            <div class="lg:col-span-6 relative flex justify-center items-center pt-10 lg:pt-0">
                <div class="absolute right-[-10%] top-[-10%] w-[110%] h-[120%] bg-gradient-to-bl from-slate-950 via-slate-900 to-blue-950 rounded-[40px] -z-20 overflow-hidden hidden lg:block shadow-2xl">
                    ...
                    <div class="absolute top-24 right-20 w-48 h-1 bg-brand-500/30 blur-md rotate-12"></div>
                </div>
                ...
                <div class="absolute bottom-6 left-2 sm:left-6 bg-white/90 backdrop-blur-xl border border-white/60 p-5 rounded-2xl w-64 shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-20 space-y-4">
                    ...
                    <div class="space-y-3.5 text-xs font-semibold text-slate-600">
                        <div class="flex justify-between items-center">
                            <span class="text-slate-400 flex items-center gap-2"><i data-lucide="calendar" class="w-4 h-4 text-brand-500"></i> Reservas Hoy</span>
                            <span class="font-bold text-slate-900 text-sm">24</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-slate-400 flex items-center gap-2"><i data-lucide="wrench" class="w-4 h-4 text-brand-500"></i> Mantenimientos</span>
                            <span class="font-bold text-slate-900 text-sm">182</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-slate-400 flex items-center gap-2"><i data-lucide="users" class="w-4 h-4 text-brand-500"></i> Clientes Activos</span>
        ...
        <div id="buscar-placa" class="mt-20 bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-[0_15px_40px_rgba(0,0,0,0.03)] grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            <div class="lg:col-span-4 flex items-center gap-4">
                <div class="p-3.5 bg-brand-50 text-brand-600 rounded-2xl shrink-0">
            ...
            <form action="#" method="GET" class="lg:col-span-8 grid grid-cols-1 sm:grid-cols-12 gap-4 w-full">
                <div class="sm:col-span-9 relative">
                    ...
                    <input type="text" name="placa" placeholder="Ej: ABC123, BCD456" 
                        class="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-blue-100 transition font-mono uppercase tracking-wider text-sm">
                </div>
                <button type="submit" class="sm:col-span-3 bg-brand-600 hover:bg-brand-700 {{ $colorview == 'dark' ? 'text-gray-400' : 'text-gray-600' }} font-bold py-4 px-6 rounded-xl transition flex items-center justify-center gap-2 text-sm shadow-md shadow-brand-600/10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mt-16 pt-10 border-t border-slate-100">
            <div class="flex gap-3.5">
                <i data-lucide="calendar-days" class="w-5 h-5 text-brand-600 shrink-0 mt-0.5"></i>
                <div>
            ...
            <div class="flex gap-3.5">
                <i data-lucide="clipboard-list" class="w-5 h-5 text-brand-600 shrink-0 mt-0.5"></i>
                <div>
            ...
            <div class="flex gap-3.5">
                <i data-lucide="map-pin" class="w-5 h-5 text-brand-600 shrink-0 mt-0.5"></i>
                <div>
            ...
            <div class="flex gap-3.5">
                <i data-lucide="package" class="w-5 h-5 text-brand-600 shrink-0 mt-0.5"></i>
                <div>
            ...
            <div class="flex gap-3.5">
                <i data-lucide="shield-check" class="w-5 h-5 text-brand-600 shrink-0 mt-0.5"></i>
                <div>
