                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row ">
                                            <h5 class="card-title text-center"
                                                style="background-color: #80A442; color: white; padding: 10px;">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <i class="fa fa-file-alt"
                                                                style="font-size: 14px; color: #6c757d;"></i>
                                                        </span>
                                                    </div>
                                                    <select id="COM_TipoDocumento" name="COM_TipoDocumento"
                                                        style="font-size: 14px; text-align: left; padding-left: 10px; height: 100%;"
                                            ...
                                            <div class="col-md-6 pl-0">
                                                <input type="text" class="form-control" id="COM_NumDocumento"
                                                    style="font-size: 14px; text-align: left; padding-left: 10px; height: 100%;"
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-md-7 pl-0 pr-0">
                                                <select class=" select2 form-control form-control-sm" id="idMEP_Id"
                                                    name="MEP_Id" required="">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mb-3">
                                            <h5 class="card-title text-center"
                                                style="background-color: #80A442; color: white; padding: 10px;">Información
                                                del producto
                                            </h5>
                                            <p></p>
                                            <!-- Columna Producto -->
                                        ...
                                        <button type="button" onclick="GenerarCompra();" id="saveBtn" class="btn btn-success"><i class="fas fa-save"></i>Generar
                                            Compra</button>
                                    </div>
                                </div>
                            </div>
    ...
    @section('script')
        <script>
            ...
            function GenerarCompra() {
                ...
                $.ajax({
                    ...
                    error: function(data) {
                        ...
                        Toast.fire({
                            type: 'error',
                            title: 'Compra fallo al Registrarse.'
                        })
                    }
                });
            }
            ...
            function CargarData(){
                ...
                var COM_Id = '<?php echo $data->COM_Id; ?>';
                var COM_TipoDocumento = '<?php echo $data->COM_TipoDocumento; ?>';
                var COM_NumDocumento = '<?php echo $data->COM_NumDocumento; ?>';
                var COM_TipoPago = '<?php echo $data->COM_TipoPago; ?>';
                var MEP_Id = '<?php echo $data->MEP_Id; ?>';
                var PROV_Id = '<?php echo $data->PROV_Id; ?>';                
                var Detalle = JSON.parse('<?php echo json_encode($data->detalle_compra); ?>');

                $('#COM_TipoDocumento').val(COM_TipoDocumento);
                $('#COM_NumDocumento').val(COM_NumDocumento);
                $('#idCOM_TipoPago').val(COM_TipoPago);
                $('#idMEP_Id').val(MEP_Id);
                $('#idMEP_Id').change();
                $('#PROV_Id').val(PROV_Id);
                $('#PROV_Id').change();
