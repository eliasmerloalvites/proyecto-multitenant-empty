    ...
    <div class="col-5">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text"></p>
                <form method="POST" id="cat_form" action="{{ tenant_url('tenant.inventario.categoria.store') }}">
                    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#lista_categorias').DataTable({
                ...
                ajax: "{{ tenant_url('tenant.inventario.categoria.index') }}",
                columns: [{
                        data: 'CAT_Id',
                        name: 'CAT_Id',
            ...
            $('#saveCategoria').click(function(e) {
                ...
                $.ajax({
                    url: "{{ tenant_url('tenant.inventario.categoria.store') }}",
                    type: "POST",
                    data: formData,
