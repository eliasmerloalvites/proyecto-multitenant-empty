        ...
        <div class="col-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"></p>
                    <form method="POST" id="class_form" action="{{ route('tenant.inventario.clase.store', tenant('id')) }}">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#tabla_clase').DataTable({
                ...
                ajax: "{{ route('tenant.inventario.clase.index', tenant('id')) }}",
                columns: [{
                        data: 'CLA_Id',
                        name: 'CLA_Id'
                    },
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('tenant.inventario.clase.store', tenant('id')) }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.editClase', function() {
                ...
                $.get('{{ route('tenant.inventario.clase.edit', ['tenant' => tenant('id'), 'clase' => ':clase']) }}'.replace(':clase', Clase_id_edit),
                    function(result) {
                        console.log(result);
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    data: $('#class_form').serialize(),
                    url: '{{ route('tenant.inventario.clase.update', ['tenant' => tenant('id'), 'clase' => ':clase']) }}'.replace(
            ...
            $('body').on('click', '.deleteClase', function() {
                ...
                if ($confirm == true) {
                    $.ajax({
                        ...
                        url: '{{ route('tenant.inventario.clase.destroy', ['tenant' => tenant('id'), 'clase' => ':clase']) }}'.replace(
