        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"></p>
                    <form method="POST" id="gasto_form" action="{{ route('tenant.compras.gasto.store', tenant('id')) }}">
                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" id="proveedor_form" action="{{ route('tenant.compras.proveedor.store', tenant('id')) }}">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#tabla_gasto').DataTable({
                ...
                ajax: "{{ route('tenant.compras.gasto.index', tenant('id')) }}",
                columns: [{
                        data: 'GAS_Id',
                        name: 'GAS_Id',
            ...
            $('#SaveProveedor').click(function(e) {
                ...
                if (form.checkValidity()) {
                    $.ajax({
                        ...
                        url: "{{ route('tenant.compras.proveedor.store', tenant('id')) }}",
                        type: "POST",
                        dataType: 'json',
            ...
            $('#saveBtn').click(function(e) {
                ...
                if (form.checkValidity()) {
                    ...
                    $.ajax({
                        url: "{{ route('tenant.compras.gasto.store', tenant('id')) }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $('body').on('click', '.editGasto', function() {
                ...
                $.get('{{ route('tenant.compras.gasto.edit', ['gasto' => ':gasto', 'tenant' => tenant('id')]) }}'.replace(':gasto', Gasto_id_edit),
                    function(result) {
                        console.log(result);
            ...
            $('body').on('click', '.eyeGasto', function() {
                ...
                $.get('{{ route('tenant.compras.gasto.show', ['gasto' => ':gasto', 'tenant' => tenant('id')]) }}'.replace(':gasto',
                        Gasto_id_ver),
                    function(data) {
                        console.log(data)
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('tenant.compras.gasto.update', ['gasto' => ':gasto', 'tenant' => tenant('id')]) }}'.replace(
            ...
            $('body').on('click', '.deleteGasto', function() {
                ...
                if ($confirm == true) {
                    $.ajax({
                        ...
                        url: '{{ route('tenant.compras.gasto.destroy', ['gasto' => ':gasto', 'tenant' => tenant('id')]) }}'.replace(
