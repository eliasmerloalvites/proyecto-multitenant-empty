    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#tabla_proveedor').DataTable({
                ...
                ajax: "{{ route('tenant.compras.proveedor.index', tenant('id')) }}",
                columns: [{
                        data: 'PROV_Id',
                        name: 'PROV_Id'
                    },
            ...
            $('body').on('click', '.editProveedor', function() {
                ...
                $.get('{{ route('tenant.compras.proveedor.edit', ['proveedor' => ':proveedor', 'tenant' => tenant('id')]) }}'.replace(':proveedor',
                        Proveedor_id_edit),
                    function(result) {
                        console.log(result);
            ...
            $('body').on('click', '.eyeProveedor', function() {
                ...
                $.get('{{ route('tenant.compras.proveedor.show', ['proveedor' => ':proveedor', 'tenant' => tenant('id')]) }}'.replace(':proveedor',
                        Proveedor_id_ver),
                    function(data) {
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    data: $('#proveedor_form').serialize(),
                    url: '{{ route('tenant.compras.proveedor.update', ['proveedor' => ':proveedor', 'tenant' => tenant('id')]) }}'.replace(':proveedor',
                        Proveedor_id_update),
                    type: "PUT",
                    dataType: 'json',
                    success: function(data) {
            ...
            $('body').on('click', '.deleteProveedor', function() {
                ...
                if ($confirm == true) {
                    $.ajax({
                        ...
                        url: '{{ route('tenant.compras.proveedor.destroy', ['proveedor' => ':proveedor', 'tenant' => tenant('id')]) }}'.replace(
