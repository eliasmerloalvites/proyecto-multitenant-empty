    ...
    <div class="card">
        <div class="card-body">
            ...
            <button type="button" class="btn btn-primary btn-lg float-right"
                onclick="window.location.href='{{ route('tenant.compras.compra.create', tenant('id')) }}'">
                + Nuevo
            </button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#tabla_compra').DataTable({
                ...
                ajax: {
                    url: "{{ route('tenant.compras.compra.index', tenant('id')) }}",
                    type: "GET",
            ...
            $('body').on('click', '.eyeCompra', function() {
                ...
                $.get('{{ route('tenant.compras.compra.show', ['compra' => ':compra', 'tenant' => tenant('id')]) }}'.replace(':compra',
                        Compra_id_ver),
                    function(data) {
                        console.log(data)
