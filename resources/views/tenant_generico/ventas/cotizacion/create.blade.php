        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 cot-form-group">
                    ...
                    <input type="date" class="form-control" id="cotFechaVencimiento">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 cot-form-group mb-0">
                    ...
                    <textarea class="form-control" id="cotObservaciones" rows="2" maxlength="500"></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card cot-card">
        <div class="card-body">
            ...
            <div class="cot-acciones-footer">
                ...
                <a href="{{ tenant_url('tenant.ventas.cotizacion.index') }}" class="btn btn-light border cot-btn-cancelar">
                    Cancelar
                </a>
            </div>
        </div>
...
<script>
    ...
    function guardarCotizacion() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ tenant_url('tenant.ventas.cotizacion.store') }}",
            data: {
                _token: '{{ csrf_token() }}',
            ...
            success: function(data) {
                Swal.fire({
                    ...
                    window.location = "{{ tenant_url('tenant.ventas.cotizacion.index') }}";
                });
            },
            error: function(xhr) {
                var data = xhr.responseJSON || {};
                var motivo = data.error || (data.errors ? Object.values(data.errors)[0][0] : 'No se pudo registrar la cotización.');
                Swal.fire({ icon: 'error', title: 'No se pudo guardar', text: motivo });
            },
            complete: function() {
