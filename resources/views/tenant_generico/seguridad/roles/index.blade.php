                ...
                <form id="RoleForm" name="RoleForm"  >
                    ...
                    <div class="form-group text-right">
                        ...
                        @can('tenant.seguridad.roles.edit')
                            <button type="button" id="updateBtn" name="updateBtn" class="btn btn-default" disabled>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-roles').DataTable({
                ...
                ajax: "{{ route('tenant.seguridad.role.index', tenant('id')) }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('tenant.seguridad.role.store', tenant('id')) }}",
                    type: "POST",
                    dataType: 'json',
            ...
            $('body').on('click', '.deleteRole', function() {
                ...
                if ($confirm == true) {
                    $.ajax({
                        ...
                        url: '{{ route('tenant.seguridad.role.destroy',  ['rol' => ':rol', tenant('id')]) }}'.replace(':rol',
                            Role_id_delete),
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
            ...
            $('body').on('click', '.editRole', function() {
                ...
                $.get('{{ route('tenant.seguridad.role.edit', ['rol' => ':rol', tenant('id')]) }}'.replace(':rol', Role_id_edit),
                    function(data) {
                        console.log(data);
            ...
            $('#updateBtn').click(function(e) {
                ...
                $.ajax({
                    data: $('#RoleForm').serialize(),
                    url: '{{ route('tenant.seguridad.role.update', ['rol' => ':rol', tenant('id')]) }}'.replace(':rol',
                        Role_id_update),
                    type: "PUT",
                    dataType: 'json',
                    success: function(data) {
            ...
            $('body').on('click', '.eyeRole', function() {
                ...
                $.get('{{ route('tenant.seguridad.role.show', ['rol' => ':rol', tenant('id')]) }}'.replace(':rol', Role_id_ver),
                    function(data) {
                        console.log(data);
