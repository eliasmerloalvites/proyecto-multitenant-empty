...
<script>
    $(document).ready(function() {
        ...
        var table = $('#table-users').DataTable({
            ...
            ajax: "{{ tenant_url('tenant.seguridad.usuario.index') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
        ...
        $('#saveBtn').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ tenant_url('tenant.seguridad.usuario.store') }}",
                type: "POST",
                dataType: 'json',
        ...
        $('body').on('click', '.deleteUsuario', function() {
            ...
            if ($confirm == true) {
                $.ajax({
                    ...
                    url: '{{ tenant_url('tenant.seguridad.usuario.destroy', ['usuario' => ':usuario']) }}'.replace(':usuario', Usuario_id_delete),
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
                    success: function(data) {
        ...
        $('body').on('click', '.eyeUsuario', function() {
            ...
            $.get('{{ tenant_url('tenant.seguridad.usuario.show', ['usuario' => ':usuario']) }}'.replace(':usuario', Usuario_id_ver),
                function(data) {
                    console.log(data);
