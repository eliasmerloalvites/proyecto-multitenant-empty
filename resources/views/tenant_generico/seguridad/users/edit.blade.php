...
<div class="container ">
    <form action="{{route('tenant.seguridad.usuario.update',[tenant('id'),$usuario->id])}}" method="post">
        @method('put')
        @csrf
       ...
       <center> <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i>Guardar</button>
        <a href="{{route('tenant.seguridad.usuario.cancelar',tenant('id'))}}" class="btn btn-danger" ><i class="fas fa-ban"></i>Regresar</a></center>
    </form>
